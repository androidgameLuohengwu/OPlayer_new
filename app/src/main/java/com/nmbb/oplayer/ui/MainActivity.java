...
import com.nmbb.oplayer.util.SDcardUtils;
...
public class MainActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (pref.getBoolean(OPlayerApplication.PREF_KEY_FIRST, true)) {
			startService(new Intent(getApplicationContext(), MediaScannerService.class).putExtra(MediaScannerService.EXTRA_DIRECTORY, SDcardUtils.getInternalSDCardPath()));
		}

		super.setContentView(R.layout.fragment_pager);
